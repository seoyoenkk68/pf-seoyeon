...
<section class="portfolio section section-1">
  <div class="con">
    <div class="box-1">
      <div class="head flex">
        <div class="txt-title">Portfolio</div>
        <div class="flex-grow"></div>
        <ul class="flex">
          <li data-tb="tab-box-1__1__head" data-tb-clicked><a href="#" class="flex p-5 font-bold">All</a></li>
          <li data-tb="tab-box-1__2__head"><a href="#" class="flex p-5 font-bold">Web/Mobile</a></li>
          <li data-tb="tab-box-1__3__head"><a href="#" class="flex p-5 font-bold">Design</a></li>
          <!--           <li data-tb="tab-box-1__3__head"><a href="#" class="flex p-5 font-bold">artwork</a></li> -->
        </ul>
      </div>
      <div class="body">
        <ul>
          <li data-tb="tab-box-1__1__body">
            <ul class="list flex">
              <li>
                <div class="content-wrap flex flex-col justify-end">
                  <div class="txt-wrap">
                    <span class="title">한글과 컴퓨터 말랑말랑 웹페이지 모작</span>
                    <span class="content">작업기간 2021.05.29~6.13</span>
                  </div>
                  <div class="btn-wrap flex justify-center">
                    <a href="https://codepen.io/sbyeony/full/ExWOamb" target="_blank" class="btn btn-1">codepen
                      open</a>
                    <!-- <a href="#" class="btn btn-2">PROCESS</a> -->
                  </div>
                </div>
              ...
              <li>
                <div class="content-wrap flex flex-col justify-end">
                  <div class="txt-wrap">
                    <span class="title">글로오아시스 웹페이지 모작</span>
                    <span class="content">작업기간 2021.06.15~6.25</span>
                  </div>
                  <div class="btn-wrap flex justify-center">
                    <a href="https://codepen.io/sbyeony/full/wvJVLmb" target="_blank" class="btn btn-1">codepen
                      open</a>
                  </div>
                </div>
              ...
              <li>
                <div class="content-wrap flex flex-col justify-end">
                  <div class="txt-wrap">
                    <span class="title">동아출판 웹페이지 모작</span>
                    <span class="content">작업기간 2021.06.28~7.1</span>
                  </div>
                  <div class="btn-wrap flex justify-center">
                    <a href="https://codepen.io/sbyeony/full/VwbLpNB" target="_blank" class="btn btn-1">codepen
                      open</a>
                  </div>
                </div>
              ...
              <li>
                <div class="content-wrap flex flex-col justify-end">
                  <div class="txt-wrap">
                    <span class="title">미래에셋 웹페이지 모작</span>
                    <span class="content">작업기간 2021.7.6~7.12</span>
                  </div>
                  <div class="btn-wrap flex justify-center">
                    <a href="https://codepen.io/sbyeony/full/eYWBpjd" target="_blank" class="btn btn-1">codepen
                      open</a>
                  </div>
                </div>
              ...
              <li>
                <div class="content-wrap flex flex-col justify-end">
                  <div class="txt-wrap">
                    <span class="title">타슈 어플리케이션 리디자인</span>
                    <span class="content">작업기간 2021.8</span>
                  </div>
                  <div class="btn-wrap flex justify-center">
                    <a href="https://notefolio.net/sbyeony/256395" target="_blank" class="btn btn-1">notefolio
                      open</a>
                    <a href="https://seoyoenkk68.github.io/tashu_redesign/" target="_blank" class="btn btn-2">process
                      open</a>
                  </div>
                </div>
              ...
              <li>
                <div class="content-wrap flex flex-col justify-end">
                  <div class="txt-wrap">
                    <span class="title">야마하뮤직코리아 웹사이트 리디자인</span>
                    <span class="content">작업기간 2021.9</span>
                  </div>
                  <div class="btn-wrap flex justify-center">
                    <a href="https://notefolio.net/sbyeony/266043" target="_blank" class="btn btn-1">notefolio
                      open</a>
                    <a href="https://seoyoenkk68.github.io/yamaha_redeisgn/" target="_blank" class="btn btn-2">website
                      open</a>
                  </div>
                </div>
              ...
              <li>
                <a href="https://rawcdn.githack.com/seoyoenkk68/pf-seoyeon/master/image/artworkfull1.png"
                  data-lightbox="image-1" data-title="일러스트레이터 실습 - 영화 인셉션 아트 포스터">
                  <img class="aimg-1" src="https://rawcdn.githack.com/seoyoenkk68/pf-seoyeon/master/image/artwork1.png"
                    alt="">
                </a>
              </li>
              <li>
                <a href="https://rawcdn.githack.com/seoyoenkk68/pf-seoyeon/master/image/artworkfull2.png"
                  data-lightbox="image-1" data-title="포토샵 실습 - 사진전 포스터 - 1">
                  <img class="aimg-1" src="https://rawcdn.githack.com/seoyoenkk68/pf-seoyeon/master/image/artwork2.png"
                    alt="">
                </a>
              </li>
              <li>
                <a href="https://rawcdn.githack.com/seoyoenkk68/pf-seoyeon/master/image/artworkfull3.png"
                  data-lightbox="image-1" data-title="포토샵 실습 - 사진전 포스터 - 2">
              ...
              <li>
                <a href="https://rawcdn.githack.com/seoyoenkk68/pf-seoyeon/master/image/artworkfull6.png"
                  data-lightbox="image-1" data-title="박찬미 찬양콘서트 포스터">
                  <img class="aimg-1" src="https://rawcdn.githack.com/seoyoenkk68/pf-seoyeon/master/image/artwork6.png"
                    alt="">
                </a>
              </li>
              <li>
                <div class="content-wrap flex flex-col justify-end">
                  <div class="txt-wrap">
                    <span class="title">유튜브 영상제작</span>
                    <!-- <span class="content">작업기간 2021.10</span> -->
                  </div>
                  <div class="btn-wrap flex justify-center">
              ...
              <li>
                <a href="https://rawcdn.githack.com/seoyoenkk68/pf-seoyeon/master/image/artworkfull9.png"
                  data-lightbox="image-1" data-title="새하늘교회 포스터">
                  <img class="aimg-1" src="https://rawcdn.githack.com/seoyoenkk68/pf-seoyeon/master/image/artwork9.png"
                    alt="">
                </a>
              </li>
            </ul>
